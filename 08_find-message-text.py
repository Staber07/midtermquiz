...
for message in messages:
    if message["text"].find(messageText) != -1:
        ...
        print("Email address:", message["sender"]["emailAddress"])
        print("Date/Time created:", message["timestamp"])
...
if messageCounter == 0:
    print("No messages were found using this criteria.")
else:
    print(f"{messageCounter} messages were found using this criteria.")
